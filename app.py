...
def index():
    ...
    if request.headers.get("Authorization"):
        ...
        if current_auth_key == API_KEY:
            ...
            "Crime Analysis"
            "Breakdown by crime type with a focus on the most severe incidents"
            "Patterns, timings, and demographics most affected in tourist hotspots"
